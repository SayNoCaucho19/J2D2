...
# Colores tema marino
OCEAN_COLORS = {
    "deep_blue": "#000000",      # Azul profundo
    "ocean_blue": "#01115A",     # Azul océano
    "sea_blue": "#1B6EC2",       # Azul mar
    "aqua_blue": "#2E8BC0",      # Azul agua
    "light_aqua": "#52B2CF",     # Azul claro
    "foam": "#B8D4E3",           # Espuma de mar
    "white": "#FFFFFF",          # Blanco
    "seaweed": "#FFFFFF",        # Verde alga
    "coral": "#000000",          # Coral para alert
    "gold": "#050505",           # Oro para acentos
}
...
class AquaCleanInterface(Node):
    ...
    def process_gui_updates(self):
        """Procesar imágenes y actualizar display"""
        try:
            if not self.gui_queue.empty():
                ...
                self.camera_display.image = image_tk  # evitar GC
        except Exception as e:
    ...
    def create_lobby_screen(self):
        ...
        buttons_data = [
            ...
            ("ℹABOUT US!", self.show_about, OCEAN_COLORS["sea_blue"]),
